						...
						<div class="row">
							...
							<div class="top-line__col col-auto">
								<div class="top-line__text top-line__text--tel">
									...
									<div><a class="top-line__tel" href="tel:+7351946-02-03">+7 3519 46-02-03</a>
				...
				<div class="container">
					<div class="footer__row row">
						...
						<div class="footer__col col-sm-auto">
							<div class="footer__text footer__text--tel">
								...
								<div><a class="footer__tel" href="tel:+73519460203">+7 3519 46-02-03 </a>
								</div>
					...
					<div class="footer__policy text-md-left text-center">
						<div class="footer__policy-row row">
							...
							<div class="col-auto"><a class="text-body tdu" href="processing-conditions.pdf" target="_blank">Пользовательское соглашение </a></div>
						</div>
						<div class="footer__develop-row row">
							<div class="col-lg-6">
								<div class="footer__develop">
									Создание и продвижение сайта:  <a class="text-success tdu" href="https://studiobars.ru/" target="_blank">Студия &laquo;Барс&raquo;</a>
								</div>
							</div>
			...
			<form action="thanks.php" method="post">
				...
				<div class="row no-gutters">
					...
					<div class="col">
						...
						<div class="form-wrap__toggle"> <span>Укажите необходимое количество, если знаете</span>
						</div>
